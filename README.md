...
다양한 사용자 입력 시나리오에 대해 프론트엔드 유효성 검증 및 백엔드 예외 처리가 정상 동작하는지 테스트 진행
...
| **2. 빈 입력** | 필수 조건 항목 미선택 상태에서 제출 | JS 경고창(`alert`) 출력 및 제출 차단 (`if (!goal || !level || !time)`) | <img width="862" height="441" alt="image" src="https://github.com/user-attachments/assets/d247b19d-de7b-4e3f-b4a4-9718a4be9e6c" />
 |
